...
@Component({
  selector: 'app-estadisticas-centros-comunidad',
  templateUrl: './estadisticas-centros-comunidad.component.html',
  styleUrls: ['./estadisticas-centros-comunidad.component.scss']
})
export class EstadisticasCentrosComunidad implements OnInit {
  ...
  constructor (
    ...
    this.listaCentrosComunidad  = this.servicioAplicacion.listadoCentros;
  ...
  private iniciarFormulario() {
    ...
    this.formulario = new FormGroup({
      idCentro: new FormControl({value: 0, disabled: false}, [Validators.required, Validators.min(1)]),
  ...
  public pedirEstadisticasTodasCarpetas() {
    ...
    if (this.formulario.valid) {
      ...
      this.servicioEstadisticasCentro.getDatosGraficosEstadisticasCarpetasCentro(
        parseInt(this.ultimaBusquedaDeTodasCarpetas.idCentro),
  ...
  public pedirEstadisticasDeCarpeta() {
    ...
    if (this.selectorCarpeta.valid) {
      ...
      this.servicioEstadisticasCentro.getDatosGraficosEstadisticasCarpetaCentro(
        parseInt(this.ultimaBusquedaDeTodasCarpetas.idCentro),
